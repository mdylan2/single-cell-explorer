...
class ServerConfig(BaseConfig):
    ...
    def handle_authentication(self):
        ...
        if self.authentication__type == "tests" and not self.authentication__insecure_test_environment:
            raise ConfigurationError("Test auth can only be used in an insecure tests environment")
