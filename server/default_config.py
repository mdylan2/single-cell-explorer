...
server:
  app:
    ...
    #     For a local tests (where the server runs on "http://localhost:<port>"), then the api_base_url may be
  ...
  authentication:
    # The authentication types may be "none", "session", "oauth" or "tests"
    ...
    # tests: Simple module for testing the authentication logic without connecting to an external service
    type: tests
  ...
  multi_dataset:
    ...
    #   true:  loads a tests index page, which links to the datasets that are available in the dataroot
