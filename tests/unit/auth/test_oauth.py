...
# This tests starts a cellxgene server and a mock oauth server.
...
from server.test.test_server.unit import BaseTest
...
class AuthTest(BaseTest):
    ...
    def setUpClass(cls):
        ...
        # If it gets to 5 seconds, which is shouldn't, we assume something has gone wrong and fail the tests.
        server_okay = False
        for _ in range(5):
            try:
