...
from server.common.fbs import encode_matrix_fbs, decode_matrix_fbs
from server.data_common.matrix_loader import MatrixDataLoader
from server.test.test_server.performance.create_test_matrix import create_test_h5ad
from server.test.test_server.unit import app_config
from server.test import PROJECT_ROOT, FIXTURES_ROOT


class DiffExpTest(unittest.TestCase):
    """Tests the diffexp returns the expected results for one tests case, using different
