...
from tests import BaseTest, skip_if
...
# TODO(#1281): Switch back to dynamic values
    ...
    @skip_if(lambda x: os.getenv("SKIP_STATIC"), "Skip static tests when running locally")
...
fifth_dataset,,,\r
summary tests,,ACD,\r
summary tests,,AATF,\r
summary tests,,F5,\r
summary tests,,PIGU,\r
geneset_to_delete,,,\r
geneset_to_edit,,,\r
fill_this_geneset,,,\r
