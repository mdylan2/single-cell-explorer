...
from server import FilterError
from server.data_anndata import AnndataAdaptor
from tests import app_config
from tests import PROJECT_ROOT, FIXTURES_ROOT, decode_fbs
...
class AdaptorTest(unittest.TestCase):
    ...
    def test_data_type(self):
        # don't run the tests on the more exotic data types, as they don't
        # support the astype() interface (used by this tests, but not underlying app)
