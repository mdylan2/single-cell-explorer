...
from server.common.fbs import encode_matrix_fbs

"""
Before running, sign into the dataportal, copy the cookie and paste it below. To tests in staging or prod update the
